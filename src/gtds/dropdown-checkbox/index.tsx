...
export function DropdownCheckbox({
  ...
  return (
    <div className={`${className ?? ''} flex-col sm:flex sm:w-fit`} ref={ref}>
      ...
      {isDropdownOpen && (
        <span
          className={`fixed sm:absolute ${dropdownArrowPositionClasses[dropdownArrowPosition]} lg bottom-0 left-0 z-50 mt-0 flex h-screen w-screen cursor-pointer flex-col-reverse bg-black bg-opacity-25 sm:bottom-auto sm:left-auto sm:mt-10 sm:h-auto sm:w-40 sm:flex-col`}
